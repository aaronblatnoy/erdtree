...
_NL_TIER_COLOR: dict[str, str] = {
    "marika":      "\033[38;5;220m",   # pure light gold
    "radagon":     "\033[38;5;160m",   # deep saturated red (not error-red)
    "radahn":      "\033[38;5;203m",   # scarlet
    "starscourge": "\033[38;5;93m",    # purple
}

# Fallback NL color if the tier label is unknown.
_NL_DEFAULT_COLOR = "\033[38;5;160m"
