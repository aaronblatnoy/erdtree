...
_SYNONYMS: dict[str, tuple[str, ...]] = {
    ...
    "network": ("network", "interface", "ip", "link", "ping", "connectivity", "eth0", "nic", "port", "ports",
                "listening", "listen", "socket", "sockets", "bound", "open", "gateway", "connected", "wifi", "ssid"),
    "podman": ("container", "containers", "docker", "image", "images", "pod", "pods"),
    ...
    "hardware": ("gpu", "gpus", "vram", "graphics", "video", "card", "cards", "nvidia", "amd", "radeon", "cuda",
                 "cpu", "cores", "processor", "ram", "memory", "dimm", "sticks", "modules", "brand", "manufacturer",
                 "specs", "motherboard", "pci", "usb", "sensors",
